...
class Essentials(object):
    def __init__(self):
        ...
        self.information = "DEALING THE CARDS"  # In game messages
        self.easy = True  # Difficulty level
        self.bot_map = {1: "P2", 2: "P3", 3: "P4"}  # Indexing bot index to name
...
class Image(object):
    def __init__(self):
        ...
        self.again = pygame.image.load("./images/again.png") #4th Screen
